...
필요한 종속성 설치 (torch, torchvision, opencv는 다음 단계에서 별도로 설치하므로 여기에는 포함하지 않습니다):
```
pip install imageio==2.37.0 imageio-ffmpeg==0.4.7 decord einops==0.4.1 easydict OpenEXR==3.3.1
```
