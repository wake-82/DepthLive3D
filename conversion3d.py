...
def dilate_edge(depth: torch.Tensor, edge_val, input_size=None) -> torch.Tensor:
    vs = _auto_vertical_spike_strength(input_size)
    return _dilation_dilate_edge(depth, edge_val, vertical_spike_strength=vs)
        ...
        try:
            ...
            if edge_dilation_is_enabled(edge_dilation):
                ...
                with torch.inference_mode():
                    ...
                    inv = dilate_edge(inv, edge_dilation, input_size=input_size)
...
TRANSLATIONS = {
    "en": {
        ...
        "err_invalid_size_range": "Input Size must be between 64 and 518.",
    ...
    "ko": {
        ...
        "err_invalid_size_range": "입력 크기는 64~518 사이여야 합니다.",
...
class StereoVideoGUI(QMainWindow):
    def __init__(self):
        ...
        self.spin_edge = QSpinBox(); self.spin_edge.setRange(0, 12); self.spin_edge.setValue(2)
        ...
        self.cmb_input_size.lineEdit().setValidator(QIntValidator(64, 518, self.cmb_input_size))
...
\
    ...
    def _apply_config(self, cfg: dict):
        ...
        try:
            ...
            _loaded_isz = max(64, min(518, int(cfg.get("input_size", _isz_fallback))))
        except (TypeError, ValueError):
    ...
    def _validate(self) -> str | None:
        ...
        try:
            ...
            if isz < 64 or isz > 518: return self._tr("err_invalid_size_range")
    ...
    def _start(self):
        ...
        try:
            isz = int(self.cmb_input_size.currentText().strip())
            isz = max(64, min(518, self._round_input_size(isz)))
